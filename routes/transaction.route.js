...
import { allMonthSalesAnalytic, cancelTransaction, checkOutCreditTransaction, checkOutQrisTransaction, checkOutVATransaction, createTransaction, deliveryDetail, fetchSalesByCategory, getAllTransactions, getTransactionById, getTransactionCount, getTransactionsByUser, monthlySalesReport, onReviewTransaction, payTransaction, printLabel, requestPickupTransaction, updateTransactionDelivery, updateTransactionStatus } from '../controllers/transaction.controller.js';
...
TransactionRoute.put('/on-review/:id', userMiddleware, onReviewTransaction);
